...
#include <saboteador_base/ParametersConfig.h>
...
namespace saboteador_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(saboteador_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(saboteador_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<saboteador_base::ParametersConfig> DynamicReconfigServer;
