#ifndef SABOTEADOR_HW_INTERFACE_H
#define SABOTEADOR_HW_INTERFACE_H
...
namespace saboteador_base
{
    ...
    class SaboteadorHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        SaboteadorHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~SaboteadorHWInterface() {}
    ...
    protected:
        ...
        // Observación, sólamente tenemos un subsciber (pasamos un msg de tipo float32[2])
